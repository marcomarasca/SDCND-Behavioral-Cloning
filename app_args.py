...
flags.DEFINE_float('dropout', 0.1, 'The dropout probabilty; default 0.1')
flags.DEFINE_string('activation', 'relu', 'The activation function; default "relu"')
flags.DEFINE_float('batch_norm', 0.9, 'The batch norm momentum, if 0 batch norm is not applied; default 0.9')
...
flags.DEFINE_boolean('preprocess', True, 'True if the generator should preprocess all the images in memory, speeds up the training but requires more memory')
