...
flags.DEFINE_float('mirror_min_angle', 0.2, 'The min steering angle needed in order to discriminate if an image should be mirrored or not')
...
flags.DEFINE_boolean('clahe', True, 'True if histogram equalization should be applied during preprocessing')
flags.DEFINE_boolean('random_transform', False, 'True if random image transformations should be applied during training')